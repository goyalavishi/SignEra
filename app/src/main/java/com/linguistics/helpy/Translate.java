...
public class Translate extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //gathering reference
        toSpeak=findViewById(R.id.editText);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String speak = toSpeak.getText().toString();
                if(speak.equals("")){
                    Toast.makeText(getApplicationContext(), "Write something", Toast.LENGTH_SHORT).show();
                    tts.speak("Write something", TextToSpeech.QUEUE_FLUSH, null);
                }
                else {
